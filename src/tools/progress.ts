import type { PiToolShell, ProgressDetails, ProgressState, TimingInfo } from "../types.js";
...
export function progressShell<TData = unknown>(options: ProgressOptions<TData>): PiToolShell<ProgressDetails<TData>> {
  return {
...
export async function emitProgress<TData = unknown>(onUpdate: ToolUpdate | undefined, options: ProgressOptions<TData>): Promise<void> {
