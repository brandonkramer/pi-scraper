/**
 * @fileoverview Output truncation helper that stores the full payload and returns a trimmed inline preview.
 */
...
import type { StoreResponseOptions } from "./store.ts";
...
export async function truncateAndStore(
	...
	const metadata = await storeResponse(value, options);
	return {
